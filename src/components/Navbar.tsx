...
const Navbar: React.FC = () => {
    ...
    return (
        // <ActiveSectionContext.Provider value={contextValue}>
            <nav className="bg-[#E4E1DD]  fixed top-0 w-full h-10 sm:h-16 md:h-16 border-b-2 border-gray-300 z-20">
                        ...
                        <div className="flex items-center h-full justify-between w-full">
                            ...
                            <div className="h-full">
                                <div className="flex items-center h-full">
                                    <button className="flex md:hidden bg-black text-white h-full items-center px-4 hover:scale-105 transition-all duration-200">
                                        <FiMenu size={24} />
                                    </button>
                            ...
                            <div className="hidden md:block">
                                <div className="flex items-baseline">
                                    ...
                                    {/* <Link activeClass="text-black" to="about" spy={true} smooth={true} offset={-70} duration={500} className="hover:text-black px-3 py-2 rounded-md text-base font-bold text-[#9E9D9D] font-sans" onSetActive={()=>setActiveSection("about me")}>About Me</Link> */}
                                    ...
                                    <Link activeClass="text-black" to="interests" spy={true} smooth={true} offset={-70} duration={500} className="px-3 py-2 rounded-md text-base font-bold hover:text-black text-[#9E9D9D] font-sans" >Interests</Link>
